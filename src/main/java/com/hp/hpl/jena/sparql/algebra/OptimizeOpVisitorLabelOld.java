...
public class OptimizeOpVisitorLabelOld extends OptimizeOpVisitorDPCaching {//rename class to OptimizeOpVisitorDPCaching to work
	/*public Query query;
	...
	public OptimizeOpVisitorLabelOld(Query query, CachingExecutor cachingExecutor, HTable table, HTable indexTable, PartitionFinder partitionFinder, boolean cacheRequests, boolean cacheResults) {
