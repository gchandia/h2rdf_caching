...
public class QueryExampleOpenRDF {
	...
	public static void main(String[] args) {
		...
		String star = prolog + NL +
				 "SELECT * WHERE {"+ 
				 "	?p <http://yago-knowledge.org/resource/hasWonPrize> <http://yago-knowledge.org/resource/Albert_Einstein> ."+
				 "	?p <http://yago-knowledge.org/resource/wasBornIn> ?place ."+
				 "	?p rdf:type <http://yago-knowledge.org/resource/Albert_Einstein> ."+
				 "	?p <http://yago-knowledge.org/resource/produced> ?book ."+
				 "	?book <http://yago-knowledge.org/resource/hasInternalWikipediaLinkTo> ?city ."+
				 "	?city <http://yago-knowledge.org/resource/isLocatedIn> <http://yago-knowledge.org/resource/Albert_Einstein> ."+
				 "	?city <http://yago-knowledge.org/resource/hasLongitude> ?lat ."+
				 "	?city <http://yago-knowledge.org/resource/hasLatitude> ?long ."+
				 "	?city <http://yago-knowledge.org/resource/hasLatitude> ?long8 ."+
				 "	?city <http://yago-knowledge.org/resource/hasLatitude> ?long2 ."+
				 "	?city <http://yago-knowledge.org/resource/hasLongitude> ?long3 ."+
				 //"	?city <http://yago-knowledge.org/resource/hasLongitude> ?long4 ."+
				 //"	?city <http://yago-knowledge.org/resource/hasLongitude> ?long5 ."+
				 //"	?city <http://yago-knowledge.org/resource/hasLongitude> ?long6 ."+
				 //"	?city <http://yago-knowledge.org/resource/hasLongitude> ?long7 ."+
				 "	?place <http://yago-knowledge.org/resource/hasLongitude> ?long1 ."+
				 "	?long <http://yago-knowledge.org/resource/hasLongitude> ?long1 ."+
				 "	}";
		

		String star1 = prolog + NL +
				 "SELECT * WHERE {"+ 
				 "	?p <http://yago-knowledge.org/resource/hasWonPrize> <http://yago-knowledge.org/resource/Albert_Einstein> ."+
				 "	?p <http://yago-knowledge.org/resource/wasBornIn> ?place ."+
				 "	?p rdf:type <http://yago-knowledge.org/resource/Albert_Einstein> ."+
				 ...
				 "	?book <http://yago-knowledge.org/resource/hasInternalWikipediaLinkTo> ?city ."+
				 "	?city <http://yago-knowledge.org/resource/isLocatedIn> <http://yago-knowledge.org/resource/Albert_Einstein> ."+
				 "	?city <http://yago-knowledge.org/resource/hasLatitude> ?lat ."+
				 "	?city <http://yago-knowledge.org/resource/hasLongitude> ?long ."+
				 //"	?city <http://yago-knowledge.org/resource/hasLongitude> ?long8 ."+
				 //"	?city <http://yago-knowledge.org/resource/hasLongitude> ?long2 ."+
				 //"	?city <http://yago-knowledge.org/resource/hasLongitude> ?long3 ."+
				 //"	?city <http://yago-knowledge.org/resource/hasLongitude> ?long4 ."+
				 //"	?city <http://yago-knowledge.org/resource/hasLongitude> ?long5 ."+
				 //"	?city <http://yago-knowledge.org/resource/hasLongitude> ?long6 ."+
