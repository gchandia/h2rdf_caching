...
public class CacheController extends Thread{
	public static TreeMap<String,CachedResults> resultCache=new TreeMap<String, CachedResults>();
	public static TreeMap<String,List<ResultRequest>> cacheRequests=new TreeMap<String, List<ResultRequest>>();
	private static TreeMap<String,List<ResultRequest>> tempRequests= new TreeMap<String, List<ResultRequest>>();
	...
	public void run() {
		...
		try {
			out = new FileOutputStream("/tmp/h2rdf_cacheController");
		...
		if(QueueDP.cacheResults){
			while(true){
				try {
					...
					//out.flush();
					TreeMap<String,List<ResultRequest>> tempCaheRequests = new TreeMap<String, List<ResultRequest>>();
					int i=0;
					while(i<1000) {
	...
	public static void newQuery() {
		tempRequests= new TreeMap<String, List<ResultRequest>>();
	}
