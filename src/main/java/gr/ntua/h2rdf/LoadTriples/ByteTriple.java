...
public class ByteTriple implements Comparable<ByteTriple>{
	private long s,p,o;
	...
	@Override
	public int compareTo(ByteTriple o1) {
		String label = s+"_"+p+"_"+o;
		String olabel = o1.getS()+"_"+o1.getP()+"_"+o1.getO();
		//System.out.println(label+" "+olabel);
		return label.compareTo(olabel);
	}
