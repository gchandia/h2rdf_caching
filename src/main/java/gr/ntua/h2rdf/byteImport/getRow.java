...
public class getRow {
	...
	public static void main(String[] args) throws NotSupportedDatatypeException {
		byte[] row = null;//ByteValues.getFullValue("<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>");
		...
		byte[] col=null;//ByteValues.getFullValue("<http://www.gate.ac.uk/ns/ontologies/arcomem-data-model.rdf#Term>");
